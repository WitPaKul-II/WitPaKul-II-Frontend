            ...
            <div class="row-50 pt-3 "  >
              <div class="row text-center justify-content-center">
                <div class="col-sm-3 m-sm-auto ">
                  <img class="img-fluid rounded-circle" src="/assets/image/team/074Rew.jpg" alt="fake news"/>
                  <div class="pt-3 ">
                    <h2>62130500074</h2>
                    <h2>Pawat Munkong</h2>
                ...
                <div class="col-sm-3 m-sm-auto">
                  <img class="img-fluid rounded-circle" src="/assets/image/team/082Earty.jpg" alt="bubaboo"/>
                  <div class="pt-3 ">
                    <h2>62130500082</h2>
                ...
                <div class="col-sm-3 m-sm-auto">
                  <img class="img-fluid rounded-circle" src="/assets/image/team/090Yok.jpg" alt="suay"/>
                  <div class="pt-3">
                    <h2>62130500090</h2>
