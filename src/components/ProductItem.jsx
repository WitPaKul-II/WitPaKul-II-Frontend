        ...
        <div class="card">
          <MDBNavLink to={"/product/" + this.props.data.product_code}>
            <div class="view overlay">
              <img src={"http://backend/images/" + this.props.data.images[0].substring(this.props.data.images[0].lastIndexOf('/')+1, this.props.data.images[0].length)} class="card-img-top" alt="" />
